  ...
  const projects = [
    {
      ...
      description:
        "This project was built for a guitar shop to manage employees and commodities easier and can cut down the manage-fee",
      cover: guitarshop,
    ...
    },
    {
      ...
      cover: twitter,
      href: "https://huyhehe.github.io/twitter-clone/",
      since: "1 year",
    },
  ];
  return (
    <>
      <div className="project-wrapper flex flex-col items-center py-[7rem]">
        <div className="flex flex-col gap-[1rem] items-center text-textPrimary">
            ...
            {projects.map((project, index) => {
              return (
                ...
                >
                  ...
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 translate-y-1/2 group-hover:-translate-y-1/2 w-full h-full transition-all group-hover:delay-300 duration-300 bg-bgSecondary rounded-md flex flex-col gap-[1rem] p-[2rem] font-bold text-textPrimary">
